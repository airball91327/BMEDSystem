...
namespace EDIS.Areas.BMED.Controllers
{
    ...
    public class SearchController : Controller
    {
        ...
        public IActionResult RepKeepIndex()
        {
            ...
            /* 處理保養狀態的下拉選單 */
            var keepResults = _context.BMEDKeepResults.ToList();
            List<SelectListItem> keepItem = new List<SelectListItem>();
            foreach (var item in keepResults)
            {
                keepItem.Add(new SelectListItem
                {
                    Text = item.Title,
                    Value = item.Id.ToString()
                });
            }
            ViewData["KeepResults"] = new SelectList(keepItem, "Value", "Text");
            ...
            QryRepKeepListData data = new QryRepKeepListData();
        ...
        public List<RepKeepSearchListViewModel> GetQryDataKeep(QryRepKeepListData qdata)
        {
            string docid = qdata.BMEDqtyDOCID;
            string ano = qdata.BMEDqtyASSETNO;
            string acc = qdata.BMEDqtyACCDPT;
            ...
            kps.Join(keepFlows, k => k.DocId, f => f.DocId,
                ...
                .ForEach(j => kv.Add(new RepKeepSearchListViewModel
                {
                    DocType = "保養",
                    DocId = j.keep.DocId,
