...
{
    public class BMEDRepairRepository : IRepository<RepairModel, string>
    {
        private readonly ApplicationDbContext _context;

        public BMEDRepairRepository(ApplicationDbContext context)
        {
            _context = context;
        }
    ...
    public class BMEDRepairDtlRepository : IRepository<RepairDtlModel, string>
    {
        private readonly ApplicationDbContext _context;

        public BMEDRepairDtlRepository(ApplicationDbContext context)
        {
            _context = context;
        }
    ...
    public class BMEDRepairFlowRepository : IRepository<RepairFlowModel, string[]>
    {
        private readonly ApplicationDbContext _context;

        public BMEDRepairFlowRepository(ApplicationDbContext context)
        {
            _context = context;
        }
    ...
    public class BMEDRepairEmpRepository : IRepository<RepairEmpModel, string[]>
    {
        private readonly ApplicationDbContext _context;

        public BMEDRepairEmpRepository(ApplicationDbContext context)
        {
            _context = context;
        }
